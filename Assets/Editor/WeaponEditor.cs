...
public class WeaponEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (showBasic)
		{
			...
			weapon.atk = EditorGUILayout.FloatField("Atk", weapon.atk);

            weapon.fireDistance = EditorGUILayout.FloatField("FireDistance", weapon.fireDistance);

            weapon.setStartPosition = EditorGUILayout.Vector3Field("SetStartPosition", weapon.setStartPosition);

            weapon.setStartRotation = EditorGUILayout.Vector3Field("SetStartRotation", weapon.setStartRotation);

            weapon.setStartLeftHandPosition = EditorGUILayout.Vector3Field("SetStartLeftHandPosition", weapon.setStartLeftHandPosition);

            weapon.setStartRightHandPosition = EditorGUILayout.Vector3Field("SetStartRightHandPosition", weapon.setStartRightHandPosition);
        }
		...
		if (showGeneral)
		{
			...
			if (weapon.type == WeaponType.Raycast)
			{
				...
				if (showPower)
				{
					...
					weapon.FireDistance = EditorGUILayout.FloatField("Range", weapon.FireDistance);
				}
			}
